...
define('PATTERN_FILES', '/^[A-Za-z0-9-_.\/]*\.(txt|php|htm|html|js|css|tpl|md|xml|json|py|c)$/i'); // empty means no pattern
		...
		<div class="row p-3">
			...
			<div class="col-md-9">
				...
				<div class="float-right">
					...
					<button type="button" class="btn btn-sm btn-dark" id="terminal-button"><i class="fa fa-terminal"></i></button>
					<!-- logout button -->
